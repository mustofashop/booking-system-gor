            ...
            <div class="card border-0 shadow rounded">
                <div class="card-header">
                    ...
                    <div class="card-header-action">
                        <a href="{{ route('bucket-2.index') }}" class="btn btn-warning" data-toggle="tooltip"
                           title="Back"><i class="fas fa-backward"></i></a>
                    </div>
                </div>
                <div class="card-body">
                    <form id="fmlabel" action="{{ route('bucket-2.store') }}" method="post"
