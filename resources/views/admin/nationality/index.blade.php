@extends('layout.dashboard.app', ['title' => 'List Nationality'])

@section('content')
<section class="section">
    @foreach ($label as $item)
    @if ($item->code == 'nationality')
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-header-action">
                        <a href="{{ route('nationality.create') }}" class="btn btn-success" data-toggle="tooltip"
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <div class="row justify-content-md-center">
                                        <a href="{{ route('nationality.edit', $item->id) }}"
        ...
        function deleteConfirmation(id, code) {
            swal({
                ...
                if (e.value === true) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "{{ url('/nationality/destroy') }}" + '/' + id,
                        data: {
                            _token: CSRF_TOKEN,
                            _method: 'DELETE',
                            id: id
                        ...
                        success: function (results) {
                            if (results.success === true) {
                                ...
                                window.location.replace("{{ url('nationality') }}");
                            } else {
