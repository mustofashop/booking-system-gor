                ...
                <div class="card border-0 shadow rounded">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <a href="{{ route('payment.index') }}" class="btn btn-warning" data-toggle="tooltip"
                                title="Back"><i class="fas fa-backward"></i></a>
                        </div>
                    </div>
                    <div class="card-body">
                        <form id="fmlabel-edit" action="{{ route('payment.store') }}" method="POST"
                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="code"
                                                    value="{{ $data->methode }}" placeholder="Enter methode" required=""
                                                    readonly>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="desc" placeholder="Enter description" required="">{{ $data->description }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label class="font-weight-bold">QRIS Code</label>
                                                <img src="{{ $qrisImage }}" alt="QR Code QRIS" class="img-fluid">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-6 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="sender"
                                            value="{{ old('sender') }}" placeholder="Enter sender" required="">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="from"
                                            value="{{ old('from') }}" placeholder="Enter from" required="">
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="note" placeholder="Enter note" required="">{{ old('note') }}</textarea>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="amount"
                                            value="{{ old('amount', $data->amount) }}" placeholder="Enter amount"
                                            required="">
                                        <div class="invalid-feedback">
