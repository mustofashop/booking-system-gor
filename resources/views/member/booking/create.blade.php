                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="member_id" name="member_id" class="select2 form-control" required="">
                                            ...
                                            @foreach ($member as $item)
                                                <option value="{{ $item->id }}">#{{ $item->number_booking }} |
                                                    {{ $item->code }} | {{ $item->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input id="code" type="text" class="form-control" name="code"
                                            value="{{ old('code') }}" placeholder="Enter code" required="" readonly>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input id="name" type="text" class="form-control" name="name"
                                            value="{{ old('name') }}" placeholder="Enter name" required="" readonly>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input id="birthday" type="text" class="form-control" name="birthday"
                                            value="{{ old('birthday') }}" placeholder="Enter name" required="" readonly>
                                        <div class="invalid-feedback">
                                        ...
                                        <select id="event_id" name="event_id" class="select2 form-control" required="">
                                            ...
                                            @foreach ($event as $item)
                                                <option value="{{ $item->id }}">{{ $item->code }} |
                                                    {{ $item->title }} | {{ date('d F Y', strtotime($item->date)) }} |
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="date"
                                            value="{{ date('Y-m-d') }}" placeholder="Enter date" required
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="event_category_id"
                                            value="{{ old('event_category_id') }}" placeholder="Choose category"
                                            required="">
                                            <option value="">-- Choose --</option>
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="category"
                                            value="{{ old('category') }}" placeholder="Choose category" required="">
                                            <option value="">-- Choose --</option>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="note" value="{{ old('note') }}" placeholder="Enter note" required=""></textarea>
                                        <div class="invalid-feedback">
                ...
                fetch('/getMemberById/' + memberId)
                    ...
                    .then(data => {
                        ...
                        if (data) {
                            ...
                            $('#birthday').val(member.place + ', ' + new Date(member.date)
                                .toLocaleDateString('id-ID')).trigger('change');
                        } else {
                    ...
                    .then(data => {
                        if (data) {
                            ...
                            if (event.image && event.image != '') {
                                imageHtml =
                                    `<img src="{{ asset('storage/event/') }}/${event.image}" class="img-thumbnail">`;
                            } else {
                                imageHtml =
